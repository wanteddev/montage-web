...
<Demo code={`import { Typography, Select, Option, OptionGroup, SelectContent, Label, FlexBox, ellipsisTypographyStyle, MenuActionArea, MenuActionAreaContent, Button } from '@wanteddev/wds';
