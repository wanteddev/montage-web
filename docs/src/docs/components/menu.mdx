...
<Demo code={`import { Button, TextInputContent, IconButton, FlexBox, Menu, MenuTrigger, TextButton, ContentBadge, MenuContent, MenuBottom, MenuBottomContent, MenuGroup, MenuItem, ChipFilter, MenuList } from '@wanteddev/wds';
