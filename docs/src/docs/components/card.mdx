    ...
    <FlexBox gap="24px" justifyContent="space-around">
      <Card>
        <CardThumbnail
          ...
          quality={95}
          overlay
          leftContent={<CardThumbnailContent variant="text">캡션</CardThumbnailContent>}
          rightContent={<CardThumbnailContent variant="icon"><IconBookmark /></CardThumbnailContent>}
        />
        <CardContent>
