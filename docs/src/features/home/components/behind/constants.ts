export const ARTICLE_ITEMS = [
  {
    title:
      'Wanted Design System 제작기<span class="max-xl:hidden">를 소개해요.</span>',
  ...
  {
    title:
      '원티드의 목소리, 원티드 산스<span class="max-xl:hidden">를 소개해요.</span>',
    description: 'by Wanted Design System Team',
  ...
  {
    title:
      '메이커를 위한 메이커들의 인터뷰<span class="max-xl:hidden">를 소개해요.</span>',
    description: 'by Wanted Design System Team',
