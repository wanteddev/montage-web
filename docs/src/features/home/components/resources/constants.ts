export const RESOURCE_ITEMS = [
  {
    ...
    updatedAt: '<span class="max-sm:hidden">Last Updated. </span>2025.06.04',
    href: 'https://www.figma.com/community/file/1355516515676178246',
    lottie: '/home/resources/1.json',
  },
  {
    title:
    ...
    lottie: '/home/resources/2.json',
  },
  {
    title: 'Pretendard JP <span class="max-sm:hidden">Dynamic Font</span>',
    updatedAt: '<span class="max-sm:hidden">Last Updated. </span>2021.06.28',
    href: 'https://github.com/orioncactus/pretendard',
    lottie: '/home/resources/3.json',
  },
];
