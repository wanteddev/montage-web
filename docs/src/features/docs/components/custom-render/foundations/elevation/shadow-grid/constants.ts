export const TOKEN_VALUES = [
  ...
  },
  {
    ...
    values: {
      ...
      android:
        'x:0px, y:2px, blurRadius:1.73px, spread:-2px, rgba(23, 23, 23, 0.06), x:0px, y:4px, blurRadius:4.33px, spread:-1px, rgba(23, 23, 23, 0.06);',
    },
  },
  {
    ...
    values: {
      ...
      android:
        'x:0px, y:4px, blurRadius:3.46px, spread:-2px, rgba(23, 23, 23, 0.07), x:0px, y:10px, blurRadius:10.39px, spread:-3px, rgba(23, 23, 23, 0.07);',
    },
  },
  {
    ...
    values: {
      ...
      android:
        'x:0px, y:6px, blurRadius:5.20px, spread:-4px, rgba(23, 23, 23, 0.08), x:0px, y:16px, blurRadius:15.59px, spread:-6px, rgba(23, 23, 23, 0.08);',
    },
  },
  {
    ...
    values: {
      ...
      android:
        'x:0px, y:10px, blurRadius:8.66px, spread:-5px, rgba(23, 23, 23, 0.1), x:0px, y:24px, blurRadius:24.25px, spread:-10px, rgba(23, 23, 23, 0.12);',
    },
  },
] as const;
