...
import ViewModeToggle from '../research/view-mode-toggle';
import { DEFAULT_VIEW_MODE } from '../research/view-mode-toggle/constants';
...
import type { ViewMode } from '../research/view-mode-toggle/constants';

const PREVIEW_ROUTE = '/preview/templates/joblist';

const TemplatesJoblist = () => {
          ...
          <Box sx={showcaseBodyStyle}>
            {viewMode === 'preview' ? (
              <Box sx={showcasePreviewImageStyle}>
                <Box
                  as="img"
                  src="/templates/joblist.jpg"
                  alt="원티드 채용 리스트 시안"
                />
              </Box>
            ) : (
              <Demo
                code={JOBLIST_SOURCE_CODE}
                viewMode="code"
                embedded
                hideCode={false}
              />
...
export default TemplatesJoblist;
