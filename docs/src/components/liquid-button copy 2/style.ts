...
export const liquidButtonLayerStyle = css`
  position: absolute;
  inset: 0;
  border-radius: inherit;
`;

export const liquidButtonBackgroundLayerStyle = css`
  z-index: 0;
`;
...
export const liquidButtonBlurLayerStyle = (maskId: string) => css`
  /* opacity: 0.67; */
...
export const liquidButtonFillOpacityStyle = css`
  background-color: rgba(255, 255, 255, 0.5);
  mix-blend-mode: normal;
  opacity: 0.5;
`;

export const liquidButtonFillDarkerStyle = css`
  background-color: #33333336;
  mix-blend-mode: color-dodge;
  opacity: 0.3;
`;

export const liquidButtonGlassEffectStyle = (theme: Theme) => css`
  box-shadow:
    inset 0 0 0.5px ${addOpacity(theme.semantic.static.black, theme.opacity[8])},
    inset 1.5px 1.5px 1px -1px ${addOpacity(theme.semantic.static.white, theme.opacity[61])},
    inset -1.5px -1.5px 1px -1px ${addOpacity(theme.semantic.static.white, theme.opacity[61])};
`;
