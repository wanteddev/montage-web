...
- **Parameters**
  ...
  | --- | --- |
  | `message` | 출력할 메시지 |
  | `font` | 폰트, 기본값은 `nil` (시스템 폰트 크기 12) |
  | `alignment` | 정렬, 기본값은 `.center` |
  | `drawOnPreviewOnly` | 프리뷰에서만 그릴지 여부, 기본값은 `true` |
- **Return Value**
...
- **Parameters**
  | Parameter | Description |
  | --- | --- |
  | `axis` | 측정할 축, 기본값은 `nil` (가로 및 세로 모두 측정) |
  | `drawOnPreviewOnly` | 프리뷰에서만 그릴지 여부, 기본값은 `true` |
- **Return Value**
...
- **Parameters**
  | Parameter | Description |
  | --- | --- |
  | `color` | 표시 색상, 기본값은 `blue` |
  | `fill` | 배경 채우기 여부, 기본값은 `false` |
  | `drawOnPreviewOnly` | 프리뷰에서만 그릴지 여부, 기본값은 `true` |
- **Return Value**
