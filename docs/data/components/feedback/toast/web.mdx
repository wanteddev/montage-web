...
<Demo code={`import { Toast, ToastContainer, ToastContent, ToastIcon } from '@montage-ui/core';
...
<Demo code={`import { FlexBox, Toast, ToastContainer, ToastContent, ToastIcon } from '@montage-ui/core';
...
<Demo code={`import { Button, Toast, ToastContainer, ToastContent, ToastIcon } from '@montage-ui/core';
