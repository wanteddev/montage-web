---
title: Toast
description: SnackbarHost를 기반으로 한 Wanted 커스텀 Toast 컴포넌트입니다.
---
...
| 값 | 설명 |
|:---|:---|
| Message | 일반 텍스트 메시지를 표시하는 스타일입니다. 아이콘은 표시되지 않습니다. |
| Positive | 긍정적인 알림을 위한 스타일입니다. 체크 아이콘과 초록색 색상이 사용됩니다. |
| Cautionary | 주의가 필요한 상황을 나타내는 스타일입니다. 삼각형 느낌표 아이콘과 주황색 색상이 사용됩니다. |
| Negative | 부정적인 상황을 나타내는 스타일입니다. X 아이콘과 빨간색 색상이 사용됩니다. |
| WantedToastVisuals | 커스텀 Toast를 위한 시각적 구성 클래스입니다. 메시지, 아이콘, variant 설정 등을 포함하며 SnackbarVisuals를 확장합니다. |
