...
<Demo code={`import { SectionMessage } from '@montage-ui/core';
...
<Demo code={`import { SectionMessage, FlexBox, TextButton } from '@montage-ui/core';
import { IconBlank } from '@montage-ui/icon';
...
<Demo code={`import { SectionMessage, FlexBox, Button } from '@montage-ui/core';
import { IconBlank } from '@montage-ui/icon';
