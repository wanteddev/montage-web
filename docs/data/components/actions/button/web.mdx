...
Primary(Default), Secondary, Assistive로 구성되어있습니다.<br/>
단, Primary는 Solid로 대체되어 사용합하기 때문에 사용을 지양하고 있습니다.
...
‘loading’ 옵션을 통해 로딩 상태를 트리커 할 수 있어요. disabled 상태와는 다르게 동작하며 아래 이벤트 실행을 막습니다.
- **onClick**
- **onMouseDown**
- **onPointerDown**
...
‘as’ 옵션을 통해 ’Link’ 등으로 활용할 수 있습니다.<br/>
