...
[FocusScope](../../../utilities/web-utility-components/focus-scope) 컴포넌트의 옵션을 제공합니다.
- `trapped`
- `trappedContent`
- `onMountAutoFocus`
- `onUnmountAutoFocus`
...
[PopperContent](../../../utilities/web-utility-components/popper) 컴포넌트의 옵션을 제공합니다.
- `referenceHidden`
...
[DismissableLayer](../../../utilities/web-utility-components/dismissable-layer) 컴포넌트의 옵션을 제공합니다.
- `onInteractOutside`
- `onFocusOutside`
