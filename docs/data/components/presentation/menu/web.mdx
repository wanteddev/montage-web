...
<Demo code={`import { Button, Menu, MenuTrigger, MenuContent, MenuItem, MenuList } from '@montage-ui/core';
...
<Demo code={`import { Button, Menu, MenuTrigger, MenuContent, MenuGroup, MenuItem, MenuList } from '@montage-ui/core';
...
<Demo code={`import { Button, Menu, MenuTrigger, MenuContent, MenuItem, MenuList, MenuItemContent, ContentBadge, IconButton, TextButton } from '@montage-ui/core';
      ...
      <MenuContent>
        <MenuList>
          <MenuItem
            ...
            value="item1"
            trailingContent={(
              <MenuItemContent variant="content-badge">
          ...
          <MenuItem
            ...
            value="item3"
            trailingContent={(
              <MenuItemContent variant="text-button">
...
`MenuItem` 컴포넌트에 `labelTrailing` prop 을 사용하여 레이블 우측에 콘텐츠를 추가할 수 있습니다.

`MenuItemLabelTrailing` 으로 감싸서 사용합니다.

<Demo code={`import { Button, Menu, MenuTrigger, MenuContent, MenuItem, MenuList, MenuItemLabelTrailing, ContentBadge } from '@montage-ui/core';
      ...
      <MenuContent>
        <MenuList>
          <MenuItem
            value="item1"
            labelTrailing={(
              <MenuItemLabelTrailing variant="verified-check" />
            )}
          >
            Item 1
          </MenuItem>
          <MenuItem
            value="item2"
            labelTrailing={(
              <MenuItemLabelTrailing variant="content-badge">
                <ContentBadge color="neutral" size="xsmall">Badge</ContentBadge>
...
`MenuItem` 컴포넌트에 `extraContent` prop 을 사용하여 텍스트 영역 하단에 추가 콘텐츠를 추가할 수 있습니다.

`MenuItemExtraContent` 로 감싸서 사용합니다.

<Demo code={`import { Button, Menu, MenuTrigger, MenuContent, MenuItem, MenuList, MenuItemExtraContent, ContentBadge } from '@montage-ui/core';
      ...
      <MenuContent>
        <MenuList>
          <MenuItem
            value="item1"
            extraContent={(
              <MenuItemExtraContent variant="text">
                Extra text
          ...
          <MenuItem
            value="item2"
            extraContent={(
              <MenuItemExtraContent variant="content-badge">
                <ContentBadge color="neutral" size="xsmall">Badge</ContentBadge>
              </MenuItemExtraContent>
            )}
          >
...
<Demo code={`import { Button, TextFieldContent, IconButton, FlexBox, Menu, MenuTrigger, TextButton, ContentBadge, MenuContent, MenuActionArea, MenuActionAreaContent, MenuGroup, MenuItem, FilterButton, MenuList } from '@montage-ui/core';
import { IconRefresh, IconSend } from '@montage-ui/icon';
...
<PropsTable component="MenuItemLabelTrailing" />

### MenuItemExtraContent

`ListCellExtraContent`와 동일한 props를 사용합니다.

<PropsTable component="MenuItemExtraContent" />
