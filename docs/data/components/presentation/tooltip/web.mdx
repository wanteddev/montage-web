...
> Deprecated 되었습니다. action이 필요한 경우 [Popover](../../../components/presentation/popover/web) 컴포넌트를 사용해주세요.
...
> Deprecated 되었습니다. closeButton이 필요한 경우 [Popover](../../../components/presentation/popover/web) 컴포넌트를 사용해주세요.
...
[PopoverContent](../../../components/presentation/popover/web) 컴포넌트의 옵션을 제공합니다.
- `referenceHidden`
