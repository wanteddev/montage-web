...
<Demo code={`import { Box, Autocomplete, AutocompleteField, AutocompleteList, TextField, TextFieldButton, AutocompleteOption, Label, FlexBox, Typography } from '@montage-ui/core';
...
<Demo code={`import { Box, Autocomplete, AutocompleteField, AutocompleteList, TextField, TextFieldButton, AutocompleteOption, Label, FlexBox } from '@montage-ui/core';
import { useState, useMemo } from 'react';
            ...
            <AutocompleteOption value={option} key={option}>
              {option.split(matcher).map((match, index) => (
                <Box
                  key={index}
                  as="span"
                  sx={matcher.test(match) && highlight.length > 0 && (theme => ({ color: theme.semantic.foreground.brand.primary }))}
                >
                  {match}
                </Box>
              ))}
            ...
            <AutocompleteOption value={option} key={option}>
              {parts.map((part, index) => (
                <Box
                  key={index}
                  as="span"
                  sx={part.highlight && (theme => ({ color: theme.semantic.foreground.brand.primary }))}
                >
                  {part.text}
                </Box>
              ))}
...
<Demo code={`import { Autocomplete, AutocompleteField, AutocompleteList, TextField, TextFieldButton, AutocompleteOption, Label, FlexBox } from '@montage-ui/core';
import { useState, useEffect, useMemo } from 'react';
...
<Demo code={`import { Typography, Autocomplete, AutocompleteField, AutocompleteList, AutocompleteGroup, AutocompleteOption, TextField } from '@montage-ui/core';
import { useState, useEffect, useMemo } from 'react';
...
<PropsTable component="AutocompleteOptionLabelTrailing" />

### AutocompleteOptionExtraContent

`ListCellExtraContent`와 동일한 props를 사용합니다.

<PropsTable component="AutocompleteOptionExtraContent" />
