...
<Demo code={`import { Slider } from '@montage-ui/core';
...
<Demo code={`import { FlexBox, Slider } from '@montage-ui/core';
...
<Demo code={`import { Slider, FlexBox, Button } from '@montage-ui/core';
