---
title: Slider
description: 특정 범위에 대한 값을 지정해요.
createdAt: 2025-05-12
---

## Basic slider

기본적으로 특정 범위 내에 값을 선택할 때 사용해요.
...
`label` prop 을 사용하여 각 Thumb 부분에 label 을 추가할 수 있어요.
...
또한 제목 영역을 표시할 때에는 `heading` 옵션을 사용해요.
...
`step` prop 을 이용하여 키보드로 조작했을 때 한번에 이동할 거리를 설정할 수 있어요.
...
Slider 를 조작할 때 다른 Thumb을 넘어갈 수 없도록 제한할 수 있어요.
...
`react-hook-form` 과 함께 유연하게 조합하여 사용할 수 있어요.
...
[WAI-ARIA Slider Pattern](https://www.w3.org/WAI/ARIA/apg/patterns/slider-multithumb/) 의 대부분을 준수해요.
