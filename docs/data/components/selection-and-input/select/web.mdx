...
<Demo code={`import { Chip, SelectMultiple, Option, OptionGroup } from '@montage-ui/core';
import { IconCloseThick } from '@montage-ui/icon';
...
<Demo code={`import { Select, Option, OptionGroup, SelectContent, FlexBox, IconButton } from '@montage-ui/core';
