---
title: Radio
description: 하나의 항목을 선택하는 요소로 사용해요.
createdAt: 2025-05-12
---

## Radio group

`RadioGroup`과 `RadioGroupItem` 을 사용하여 적절한 키보드 접근성을 제공해요.
...
`value`, `onValueChange` prop 을 사용하면 제어 컴포넌트로 동작해요.
...
[WAI-ARIA Radio Pattern](https://www.w3.org/WAI/ARIA/apg/patterns/radio/) 을 준수해요.
