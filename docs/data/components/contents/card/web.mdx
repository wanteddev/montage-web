...
<Demo code={`import { Card, CardThumbnail, CardTitle, CardCaption, CardContent } from '@montage-ui/core';
...
<Demo code={`import { FlexBox, Card, CardTitle, CardCaption, CardContent, CardContentItem, ContentBadge, CardThumbnailSkeleton } from '@montage-ui/core';
...
<Demo code={`import { useToast, ToggleIcon, Card, CardThumbnail, CardTitle, CardCaption, CardContent, CardThumbnailContent } from '@montage-ui/core';
...
<Demo code={`import { FlexBox, Card, CardThumbnail, CardTitle, CardCaption, CardContent } from '@montage-ui/core';
...
<Demo code={`import { CardSkeleton, CardThumbnailSkeleton, CardContentItemSkeleton, CardTitleSkeleton, CardCaptionSkeleton, CardContent } from '@montage-ui/core';
