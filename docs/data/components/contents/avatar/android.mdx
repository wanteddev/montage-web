...
| Small | 32dp 크기, 8dp 모서리 반경의 작은 아바타 크기입니다. |
| Medium | 40dp 크기, 10dp 모서리 반경의 중간 아바타 크기입니다. |
| Large | 48dp 크기, 12dp 모서리 반경의 큰 아바타 크기입니다. |
| XLarge | 56dp 크기, 14dp 모서리 반경의 가장 큰 아바타 크기입니다. |
| Custom | 크기, 모서리 반경, 뱃지 크기를 커스텀 할 수 있는 아바타 크기입니다. |