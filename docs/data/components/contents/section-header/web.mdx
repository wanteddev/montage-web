...
<Demo code={`import { SectionHeader } from '@montage-ui/core';
...
<Demo code={`import { SectionHeader, TextButton, FilterButton } from '@montage-ui/core';
...
<Demo code={`import { SectionHeader, SectionHeaderNavigation, SectionHeaderNavigationButton } from '@montage-ui/core';
...
<Demo code={`import { SectionHeader, FlexBox } from '@montage-ui/core';
