...
<Demo code={`import { Thumbnail } from '@montage-ui/core';
...
<Demo code={`import { Thumbnail, FlexBox } from '@montage-ui/core';
...
<Demo code={`import { Thumbnail, PlayBadge } from '@montage-ui/core';
