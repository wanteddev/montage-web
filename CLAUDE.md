...
const MyComponent = forwardRef(
  <T extends ElementType = 'div'>(
    ...
    return <Box as={(as || 'div') as T} ref={ref} sx={[myStyle(), props.sx]} {...props} />;
  },
...
```tsx
type ButtonProps = Merge<ButtonDefaultProps, ResponsiveProps<Pick<ButtonDefaultProps, 'fullWidth' | 'size'>>>;
