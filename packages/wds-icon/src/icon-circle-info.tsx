...
const IconCircleInfo = forwardRef<SVGSVGElement, Props>((props, ref) => {
  return (
    ...
    >
      ...
      />
      <path
        d="M12.9 11.5C12.9 11.0029 12.4971 10.6 12 10.6C11.5029 10.6 11.1 11.0029 11.1 11.5V16C11.1 16.4971 11.5029 16.9 12 16.9C12.4971 16.9 12.9 16.4971 12.9 16V11.5Z"
        fill="currentColor"
      />
      <path
        fillRule="evenodd"
