...
const IconChevronRightTightThickSmall = forwardRef<SVGSVGElement, Props>(
  (props, ref) => {
    return (
      ...
      >
        <path
          d="M2.58096 4.58096C2.07327 5.08864 2.07327 5.91175 2.58096 6.41943L8.16172 12.0002L2.58096 17.581C2.07328 18.0886 2.07328 18.9118 2.58096 19.4194C3.08864 19.9271 3.91175 19.9271 4.41943 19.4194L10.9194 12.9194C11.4271 12.4118 11.4271 11.5886 10.9194 11.081L4.41943 4.58096C3.91175 4.07327 3.08864 4.07327 2.58096 4.58096Z"
          fill="currentColor"
        />
      </Box>
    );
