...
export const CARD_THUMBNAIL_NAME = 'CardThumbnail';
export const CARD_THUMBNAIL_CONTENT_NAME = 'CardThumbnailContent';

export const CARD_BODY_NAME = 'CardBody';
export const CARD_ROW_NAME = 'CardRow';
...
export const CARD_ROW_SKELETON_NAME = 'CardRowSkeleton';
